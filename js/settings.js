...
(function () {
  ...
  function buildFocusSheet() {
    ...
    // before they think to worry about it.
    bodyEl.appendChild(focusAccountBlock());
  ...
  function focusAccountBlock() {
    ...
    card.appendChild(el('p', 'set-account-copy',
      'It lives on this device, and nothing here needs an account to read. ' +
